          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5 sm:py-6">
            <div className="flex gap-4 sm:gap-5 overflow-x-auto scrollbar-hide items-start justify-start">
              {STORIES.map((group, idx) => (
                ...
                >
                  <div
                    className={`w-[88px] h-[88px] sm:w-[100px] sm:h-[100px] rounded-full p-[3px] transition-transform duration-300 group-hover:scale-105 ${
                  ...
                  >
                    <div className="w-full h-full rounded-full bg-[#2C2420] p-[2.5px]">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = `https://placehold.co/100x100/2C2420/B8860B?text=${encodeURIComponent(group.username.charAt(0))}`;
                        }}
                      />
                    </div>
                  </div>
                  <span className="text-[10px] sm:text-xs text-white font-medium tracking-wide truncate max-w-[96px]">
                    {group.username}
                  </span>
                </button>
              ))}
