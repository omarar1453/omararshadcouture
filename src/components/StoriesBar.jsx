...
const STORIES = [
  {
    id: 1,
    username: 'Karigar Work',
    thumbnail: '/images/stories/karigar-thumb.jpg',
    items: [
      {
        id: 's1-1',
        type: 'video',
        src: '/videos/stories/karigar-embroidery.mp4',
        poster: '/images/stories/karigar-embroidery-poster.jpg',
        duration: 7000,
        caption: 'Hand embroidery on a crimson bridal lehenga',
        ctaText: 'Get This Made',
        ctaMessage: 'Hi, I saw the karigar embroidery story and I am interested in a similar piece.',
        linkUrl: null,
      },
      {
        id: 's1-2',
        type: 'video',
        src: '/videos/stories/karigar-zardozi.mp4',
        poster: '/images/stories/karigar-zardozi-poster.jpg',
        duration: 7000,
        caption: 'Zardozi detail work on velvet',
        ctaText: 'Enquire Now',
        ctaMessage: 'Hi, I loved the zardozi work in your story. Can I get a quote?',
        linkUrl: null,
      },
    ],
  },
  {
    id: 2,
    username: 'New Arrivals',
    thumbnail: '/images/stories/arrivals-thumb.jpg',
    items: [
      {
        id: 's2-1',
        type: 'video',
        src: '/videos/stories/new-arrival-red.mp4',
        poster: '/images/stories/new-arrival-poster.jpg',
        duration: 7000,
        caption: 'Just finished: Royal Red Bridal Set',
        ctaText: 'Ask Price',
        ctaMessage: 'Hi, what is the price for the Royal Red Bridal Set I saw in your story?',
        linkUrl: null,
      },
    ],
  },
  {
    id: 3,
    username: 'Fabric Selection',
    thumbnail: '/images/stories/fabric-thumb.jpg',
    items: [
      {
        id: 's3-1',
        type: 'video',
        src: '/videos/stories/fabric-selection.mp4',
        poster: '/images/stories/fabric-poster.jpg',
        duration: 7000,
        caption: 'Choosing the finest silk and organza',
        ctaText: 'Chat About Fabrics',
        ctaMessage: 'Hi, I saw your fabric selection story. Can you help me choose fabrics for my outfit?',
        linkUrl: null,
      },
    ],
  },
  {
    id: 4,
    username: 'Client Fitting',
    thumbnail: '/images/stories/fitting-thumb.jpg',
    items: [
      {
        id: 's4-1',
        type: 'video',
        src: '/videos/stories/client-fitting.mp4',
        poster: '/images/stories/fitting-poster.jpg',
        duration: 7000,
        caption: 'Live video fitting with a client in the UK',
        ctaText: 'Book Fitting',
        ctaMessage: 'Hi, I want to know more about how the remote fitting works.',
        linkUrl: null,
      },
    ],
  },
  {
    ...
    thumbnail: '/images/stories/bts-thumb.jpg',
    items: [
      {
        id: 's5-1',
        type: 'video',
        src: '/videos/stories/behind-scenes.mp4',
        poster: '/images/stories/bts-poster.jpg',
        duration: 7000,
        caption: 'A day in our atelier',
        ctaText: 'Visit Our Studio',
        ctaMessage: 'Hi, I loved seeing behind the scenes! Can I learn more about your studio?',
        linkUrl: null,
      },
    ],
  },
